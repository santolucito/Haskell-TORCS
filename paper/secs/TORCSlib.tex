...
This library, which we call \mbox{\ourLib}, uses Yampa~\cite{courtney2003yampa} as the core FRP library, though its structure can easily be adapted to any other Haskell FRP library.
We now explain the functionality provided by \ourLib, and highlight the ability of FRP to create modular, flexible, and clean controllers for autonomous vehicles.
