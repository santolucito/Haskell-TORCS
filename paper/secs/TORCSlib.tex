...
The controller should then output a commands to the vehicle, as a \texttt{DriveState}.
This is transformation is succinctly described as the now familiar \textit{signal function} from FRP.
