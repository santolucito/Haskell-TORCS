...
To avoid obstacles, imagine an \texttt{avoid'} function as shown in Listing~\ref{lst:loop}, which requires two images to calculate the adjusted steering command. 
